...
# Adapted from:
# https://github.com/aws-samples/amazon-bedrock-samples/blob/main/agents-and-function-calling/bedrock-agents/features-examples/05-create-agent-with-knowledge-base-and-action-group/knowledge_base.py

# Changes:
# - updated "amazon.titan-embed-text-v1" to "amazon.titan-embed-text-v2:0"
# - updated VectorDB dimension from 1536 to 1024
        ...
        body_json = {
            ...
            "mappings": {
                "properties": {
                    "vector": {
                        "type": "knn_vector",
                        "dimension": 1024,  # Previously 1536 for amazon.titan-embed-text-v1
                        "method": {
                            "name": "hnsw",
                            "engine": "faiss",
                            "space_type": "l2"
